...
@Service
public class AdministratorUserAccountUpdateService extends AbstractService<Administrator, UserAccount> {
	...
	public void bind(final UserAccount object) {
		...
		status = super.getRequest().getData("status", boolean.class);
